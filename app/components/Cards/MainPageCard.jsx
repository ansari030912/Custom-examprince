    ...
    >
      <section class="text-gray-600 body-font">
        <div class="px-5 py-5 mx-auto">
          <div class=" mb-5">
            <h1 class="sm:text-4xl text-xl font-medium title-font text-gray-700 mb-4">
          ...
          <div class="flex flex-wrap  sm:mx-auto sm:mb-2 -mx-2">
            <div class="p-1 sm:w-1/2 w-full">
              <div class="text-white bg-gradient-to-br from-gray-800 to-blue-400  focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 rounded-tl-4xl  rounded-tr-none rounded-br-none flex p-4 h-full items-center">
                <svg
                ...
                <span class="title-font font-medium">
                  <div class="font-bold ml-2 text-white">
            ...
            <div class="p-1 sm:w-1/2 w-full">
              <div class="text-white bg-gradient-to-bl from-gray-800 to-blue-400  focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 rounded-tl-4xl md:rounded-tr-3xl rounded-tl-none rounded-bl-none flex p-4 h-full items-center">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="1.8em"
                  height="1.8em"
            ...
            <div class="p-1 sm:w-1/2 w-full">
              <div class="text-white bg-gradient-to-r from-gray-800 to-blue-400  focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 rounded-tl-4xl flex p-4 h-full items-center">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="1.8em"
                  height="1.8em"
            ...
            <div class="p-1 sm:w-1/2 w-full">
              <div class="text-white bg-gradient-to-l from-gray-800 to-blue-400  focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 rounded-tl-4xl flex p-4 h-full items-center">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="1.8em"
                  height="1.8em"
            ...
            <div class="p-1 sm:w-1/2 w-full">
              <div class="text-white bg-gradient-to-tr from-gray-800 to-blue-400  focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 rounded-tl-4xl rounded-tr-none rounded-br-none md:rounded-bl-3xl flex p-4 h-full items-center">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="1.8em"
                  height="1.8em"
            ...
            <div class="p-1 sm:w-1/2 w-full">
              <div class="text-white bg-gradient-to-tl from-gray-800 to-blue-400  focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 rounded-tl-4xl rounded-tr-none rounded-bl-none rounded-br-4xl flex p-4 h-full items-center">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="1.8em"
                  height="1.8em"
