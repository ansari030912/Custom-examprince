...
import AllVendors from "@/app/components/Tables/AllVendors";
import HotExamsMW from "@/app/components/Tables/HotExamsMW";
import Footer from "@/app/components/footer/Footer";
import Navbar from "@/app/components/navbar/NavBar";
import SingleVendorsExmas from "@/app/components/Tables/SingleVendorsExmas";

const AllVendorsPerma = ({ params }) => {
  return (
    <>
      <Navbar />
      <Container maxWidth="lg">
        <Grid container spacing={2}>
          ...
          <Grid item xs={12} md={8}>
            <SingleVendorsExmas params={params} />
          </Grid>
